...
func describe(user):
	...
	return "Deals 15 Piercing damage to target enemy for 3 turns (Bypasses)"

func split_desc():
	return [
		"Deals 15 Piercing damage to target enemy for 3 turns (Bypasses)"
	]
...
func execute(user, battle):
	...
	for target in user.targeter.targets:
		...
		var damage_eff = Effect.damage_effect(15, DamageType.Type.PIERCING, 5, true)
