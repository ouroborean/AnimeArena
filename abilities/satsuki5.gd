...
func split_desc():
	return [
		["Satsuki receives 5 more healing from all sources", Color.CADET_BLUE],
		["Satsuki heals herself for 5 HP each turn", Color.CADET_BLUE]
	]
