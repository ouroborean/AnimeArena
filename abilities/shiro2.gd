...
func describe(user):
	...
	return "Deals 15 damage to one enemy. For 1 turn, Shiro's other damaging skills will also Silence the target for 1 turn and deal 10 additional damage."

func split_desc():
	return [
		"Deals 15 damage to one enemy",
		["For 1 turn, Shiro's other damaging skills silence the target for 1 turn and deal 10 additional damage", Color.CADET_BLUE]
	]
...
func execute(user, battle):
	...
	var boost = Effect.damage_mod_effect(10, eff_duration, ["Shiro Kick", "Shiro Rampage"])
	boost.set_source(self)
	var mark = Effect.mark(eff_duration, "Shiro Kick and Shiro Rampage will silence their target for 1 turn.")
