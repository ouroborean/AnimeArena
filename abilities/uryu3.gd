...
func split_desc():
	return [
		"Deals 25 piercing damage to one enemy",
		["Removes 1 random energy from the target", Color.ORANGE_RED],
		["Quincy Final Kojaku Shot costs 1 blue 1 random energy for 1 turn", Color.CADET_BLUE],
