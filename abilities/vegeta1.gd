...
func split_desc():
	return [
		"Deals 5 piercing damage to one enemy",
		["Reduces target's non-Affliction damage equal to this skill's damage for 1 turn", Color.ORANGE_RED],
		["Gains 5 more damage each turn Vegeta does not use a damaging skill, resets on next use (stacks)", Color.CADET_BLUE]
	]
