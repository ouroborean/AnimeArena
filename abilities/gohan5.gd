...
func split_desc():
	return [
		...
		["Deals +15 damage for each dead ally on Gohan's team", Color.CADET_BLUE],
		["If one of the dead allies is Goku, gets +30 damage instead", Color.DIM_GRAY]
	]
