...
func describe(user):
	...
	return "Deals 20 Affliction damage to one enemy and stuns their Helpful and Strategic skills for 1 turn."

func split_desc():
	return [
		"Deals 20 Affliction damage to one enemy",
		["Stuns their Helpful and Strategic skills for 1 turn", Color.ORANGE_RED]
	]
...
func execute(user, battle):
	...
	for target in user.targeter.targets:
		...
		var stun_eff = Effect.stun_effect(2, ["Helpful", "Strategic"])
